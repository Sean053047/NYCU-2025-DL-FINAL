...
class CogVideoXTransformer3DModelTracking(CogVideoXTransformer3DModel, ModelMixin):
    ...
    def __init__(
        ...
        **kwargs
        ...
        #     self.transformer_blocks_copy[i].load_state_dict(self.transformer_blocks[i].state_dict(), map_location='meta')
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                # print(latent_model_input.shape, tracking_maps_input.shape)
